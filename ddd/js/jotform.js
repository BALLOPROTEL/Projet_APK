    ...
    initPrefills: function() {
        ...
        JotForm.createXHRRequest(url, 'get', null, function(res) {
            $H(res.data).each(function(pair) {
                ...
                } else if (questionType === 'control_checkbox' && Array.isArray(inputValue)) {
                    JotForm.onTranslationsFetch(function() {
                        var foundValues = [];
                        line.querySelectorAll('input.form-checkbox:not(.form-checkbox-other)').forEach(function(input) {
                        ...
                        var otherOption = line.querySelector('.form-checkbox-other');
                        var otherOptionInput = line.querySelector('.form-checkbox-other-input');
